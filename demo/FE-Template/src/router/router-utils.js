...
import { buildInHomeMenu, moduleRoutes, LAYOUT_ROUTER_MAIN } from './modules';
...
export function addRouter(menus) {
	let [getRouterMap, bindingCodesMap] = routerToMap(moduleRoutes);
	...
	const register404Router = (item) => {
		...
		const route404 = {
			...
			component: () => import(/* webpackChunkName: "layout-error" */ '../layouts/error/index.vue'),
		};
